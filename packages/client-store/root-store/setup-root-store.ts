...
import type { RootStoreEnv } from '@lindo/shared'
...
export async function setupRootStore() {
  ...
  // it carries the capabilities that only exist on this side of the bridge
  const env: RootStoreEnv = {
    encryptCharacterPassword: window.lindoAPI.encryptCharacterPassword
  }
